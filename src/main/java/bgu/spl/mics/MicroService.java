...
public abstract class MicroService implements Runnable {
    ...
    private String name;
    private ConcurrentHashMap<Class<? extends Message>,Callback> callBacks; //use this hashmap so each MS can save his callBacks
    private boolean terminateCall; //when getting terminationBroadCast we use this filed to end the run method
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
    	this.bus.subscribeEvent(type,this);
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
    	this.bus.subscribeBroadcast(type,this);
    	this.callBacks.put(type,callback);
    }
    ...
    public final void run() {
        ...
        while (!terminateCall) {
            try {
                ...
                this.callBacks.get(message.getClass()).call(message);
